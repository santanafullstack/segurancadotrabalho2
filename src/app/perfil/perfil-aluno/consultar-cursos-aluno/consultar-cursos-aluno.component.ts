...
@Component({
  selector: 'app-consultar-cursos-aluno',
  templateUrl: './consultar-cursos-aluno.component.html',
  styleUrls: ['./consultar-cursos-aluno.component.css']
})
export class ConsultarCursosAlunoComponent implements OnInit {
