...
@Component({
  selector: 'app-consultar-instrutor-perfil-aluno',
  templateUrl: './consultar-instrutor-perfil-aluno.component.html',
  styleUrls: ['./consultar-instrutor-perfil-aluno.component.css']
})
export class ConsultarInstrutorPerfilAlunoComponent implements OnInit {
