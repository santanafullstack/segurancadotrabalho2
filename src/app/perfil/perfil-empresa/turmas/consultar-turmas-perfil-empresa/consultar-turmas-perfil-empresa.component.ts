...
@Component({
  selector: 'app-consultar-turmas-perfil-empresa',
  templateUrl: './consultar-turmas-perfil-empresa.component.html',
  styleUrls: ['./consultar-turmas-perfil-empresa.component.css']
})
export class ConsultarTurmasPerfilEmpresaComponent implements AfterViewInit {
