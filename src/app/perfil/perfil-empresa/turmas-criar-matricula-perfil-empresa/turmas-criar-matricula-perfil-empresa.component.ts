...
@Component({
  selector: 'app-turmas-criar-matricula-perfil-empresa',
  templateUrl: './turmas-criar-matricula-perfil-empresa.component.html',
  styleUrls: ['./turmas-criar-matricula-perfil-empresa.component.css']
})
export class TurmasCriarMatriculaPerfilEmpresaComponent implements OnInit {
  ...
  obterEmpresas(userId: string): void {
    ...
    this.httpClient.get<any[]>(endpoint)
      ...
      obterFaturamentosEmAberto(userId: string): void {
        const endpoint = `http://localhost:8082/api/faturamento/api/faturamentos-em-aberto/usuario/${userId}`;
