...
@Component({
  selector: 'app-consultar-matriculas-empresa',
  templateUrl: './consultar-matriculas-empresa.component.html',
  styleUrls: ['./consultar-matriculas-empresa.component.css']
})
export class ConsultarMatriculasEmpresaComponent implements OnInit{
  ...
  setEvidencias(evidencias: CadastrarEvidencias): void {
    ...
    this.EditarMatriculas.patchValue(evidencias);  
