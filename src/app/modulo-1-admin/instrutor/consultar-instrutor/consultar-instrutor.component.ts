...
@Component({
  selector: 'app-consultar-instrutor',
  templateUrl: './consultar-instrutor.component.html',
  styleUrls: ['./consultar-instrutor.component.css']
})
export class ConsultarInstrutorComponent implements OnInit{
